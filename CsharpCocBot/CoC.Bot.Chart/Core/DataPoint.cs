...
namespace CoC.Bot.Chart
{
    ...
    public class DataPoint : DependencyObject, INotifyPropertyChanged
    {
        ...
        public string FormattedValue
        {
            get
            {
                return string.Format(ToolTipFormat, Caption, Value, SeriesCaption, PercentageFromMaxDataPointGroupSum, PercentageFromMaxDataPointValue, PercentageFromSumOfDataPointGroup);
            }
        }
