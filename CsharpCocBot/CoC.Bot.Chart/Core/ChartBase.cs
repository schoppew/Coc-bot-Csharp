...
namespace CoC.Bot.Chart
{
    ...
    public abstract class ChartBase : Control, INotifyPropertyChanged
    {
		...
		public static void DataContextWatcher_Changed(DependencyObject sender, DependencyPropertyChangedEventArgs args)
		{
        ...
        private void UpdateDataContextOfSeries()
        {
            ...
            foreach (var newItem in Series)
            {
                if (newItem is FrameworkElement)
                {
                    (newItem as FrameworkElement).DataContext = DataContext;
                }
            }
        ...
        {
            ResourceDictionaryCollection usedPalette = DefaultPalette;
            if (Palette != null)
            {
                usedPalette = Palette;
            }
       ...
       public bool HasExceptions
        ...
        private void UpdateSeries()
        {
            ...
            if (Series != null)
            {
                if (SeriesTemplate != null)
                {
                    ...
                    {
                        if (SeriesSource is INotifyCollectionChanged)
                        {
                            (SeriesSource as INotifyCollectionChanged).CollectionChanged += SeriesSourceCollectionChanged;
                        }
        ...
        private void UpdateControls()
        {
            if (DataContext != null)
            {
                ...
                {
                    foreach (object item in (DataContext as IEnumerable))
                    {
